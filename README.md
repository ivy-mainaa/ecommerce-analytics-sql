...
**1. Clone the repo**
```bash
git clone https://github.com/ivy-mainaa/ecommerce-analytics-sql.git
```

**2. Get the data**

Download the Olist dataset from [Kaggle](https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce) and load the CSVs into PostgreSQL using pgAdmin or psql.
